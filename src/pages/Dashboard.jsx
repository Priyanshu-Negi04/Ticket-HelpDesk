  ...
  return (
    <BaseLayout>
        ...
        <div className="flex flex-wrap justify-start gap-6">
            ...
            <p className="text-7xl font-serif leading-tight" style={{ lineHeight: 1, letterSpacing: "-0.03em" }}>12</p>
            </div>
            ...
            <p className="text-7xl font-serif leading-tight" style={{ lineHeight: 1, letterSpacing: "-0.03em" }}>8</p>
            </div>
            ...
            <p className="text-7xl font-serif leading-tight" style={{ lineHeight: 1, letterSpacing: "-0.03em" }}>2</p>
            </div>
